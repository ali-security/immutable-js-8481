...
// Use require() because v4.3.7's jest preprocessor (Rollup+Buble) transforms
// `export default` to `module.exports`, not `exports.default`
const shallowCopy = require('../../src/utils/shallowCopy');
